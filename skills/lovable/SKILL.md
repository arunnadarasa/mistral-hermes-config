...
| Submission package | **KPI wall: mechanism 2/2 ✅ · submission drafts 5/5 ✅ · fresh_clone_reproducible ✅** (narrative v3 + tech report + four packs + beat-sheet) · verified_cells 51/500 climbing (pure aggregation, every cell provenance-noted) · tket sweep: every certified circuit ships its optimised twin (rotor 48→42, iceberg 72→64, observable-level equivalence) · **QTDA DQC1-hardness (25 Aug): C6 vs 2C3 WL-indistinguishable graphs DISTINGUISHED by quantum propagator trace on 4 backends (Selene/Quest + H1-1LE + H2-1LE + Helios-1E-lite); classical control row (1-WL hash + GNN aggregation + Betti) ALL FAIL; +2.5 score (scientific 13→15)** | Pretending the classifier question is open (closed **5 ways** — Fourier wall / Quest 10q / real-kernel REFUSE / flight-deck shot-floor / shot-scaling seal) |
